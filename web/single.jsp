<%-- 
    Document   : single
    Created on : Dec 17, 2013, 1:22:49 PM
    Author     : Kara
--%>
...
<html lang="en">
    <!--<![endif]-->
    <head>
        <title>Single Post - Lamoon</title>
                    ...
                    <div class="container section end">
                        <div id="footer-about" class="one-fourth column">
                            ...
                            <p>
                                ...
                                <span>Email: <a href="#"><span id="__cf_email__" class="3a5955544e5b594e7a565b5755555414595557">[email&nbsp;protected]</span><script type="text/javascript">
/* <![CDATA[ */
