<%-- 
    Document   : contact
    Created on : Dec 17, 2013, 12:52:38 PM
    Author     : Kara
--%>
    ...
    <body>
        ...
        <div id="root-container" class="container">
            <div id="wrapper" class="sixteen columns">
                ...
                <!-- Banner -->
                <div id="sub-banner">
                    <img src="images/banner/sub-banner6.jpg" alt="" />
                </div>
                ...
                <div id="menu" class="home">
                    <ul id="root-menu" class="sf-menu">
                        ...
                        <li>
                            <a href="sign-in.jsp" class="active">Sign In (Staff)</a>
                        </li>
                        <li>
                ...
                <div id="content" class="contact">
                    ...
                    <div class="container section">
                        <div class="one-third column">
                            <h3 class="nobg">For Staff</h3>
                            <p>
                                Sign in to manage the information about the hotel.
                            </p>
                        </div>
                        <div class="two-third column last">
                            <form action="SignIn" method="get">
                                <p>
                                    <label for="idH" class="required label">Hotel id:</label>
                                    <input id="idH" class="validate[required]" type="text" name="idH" />
                                </p>
                                <p>
                                    <label for="userName" class="required label">User id:</label>
                                    <input id="userName" class="validate[required]" type="text" name="userName" />
                                </p>
                                <p>
        ...
        <script type="text/javascript" src="scripts/lamoon.js?v=1"></script>
